                        ...
                        <div class="flex flex-start flex-wrap items-center mb-4 -mx-4" data-row="1">
                            <div class="px-4 flex-none">
                                <div class="" style="width: 90px; height: 90px">
                                    <img src="{{ $cart->product->galleries->first()->url }}" alt="chair-1"
                            ...
                            <div class="px-4 w-auto flex-1 md:w-5/12">
                                <div class="">
                                    ...
                                    <span class="text-sm md:text-lg">{{ $cart->product->category->name }}</span>
                            ...
                            <div class="px-4 w-2/12">
                                <div class="text-center">
                                    <form action="{{ route('cartDelete', $cart->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" {{-- data-delete-item="1" --}}
